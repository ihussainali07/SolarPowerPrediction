...
def load_raw(data_dir="data"):
    """
    Return a dictionary containing the four raw DataFrames.

    Keys:
        'gen1'    -> Plant 1 Generation Data
        'sensor1' -> Plant 1 Weather Sens or Data
        'gen2'    -> Plant 2 Generation Data
        'sensor2' -> Plant 2 Weather Sensor Data

    DATE_TIME is intentionally left as a string.
    """
